    ...
    <div class="flex flex-wrap -mx-3 mb-3">
        ...
        {{-- Filter Input --}}
            <div class="w-full px-3 mb-3">
                ...
                <input type="text" id="filter" wire:model="filter" wire:keyup="filterStocks" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-gray-500" placeholder="Enter keyword...">
            </div>
        </div>
        ...
        <div class="w-full md:w-2/3 px-3 mb-3 md:mb-0">
            ...
            <div class="w-full px-3">
                <label for="symbol-select" class="block uppercase tracking-wide text-gray-100 text-xs font-bold mb-2">Select Stock:</label>
                ...
                @else
                    <select id="symbol-select" wire:model="selectedSymbol" wire:change="addSymbol" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-gray-500">
